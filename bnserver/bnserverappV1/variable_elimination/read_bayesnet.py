...
class BayesNet():
        ...
        with open(file_path, 'r') as file:
            ...
            for line in file:
                if line.startswith('network'):
                    ...
                    self.parse_variable(line_number, file_path)
                elif line.startswith('probability'):
                    self.parse_probability(line_number, file_path)
    ...
    def parse_variable(self, line_number, filename):
        ...
        variable = open(file_path, 'r').readlines()[line_number].split()[1]
        line = open(file_path, 'r').readlines()[line_number+1]
        start = line.find('{') + 1
        end = line.find('}')
